  ...
  return (
    <section id="certificate" className="px-[5%] py-20 gap-8 flex flex-col items-center">
      <div className="flex items-center gap-3 z-[2]">
        <TbCertificate className="w-32 h-32 text-amber-600 hover:text-amber-900 hover:scale-110 duration-300 trophy" />
        <div className="flex flex-col">
          <h3 className="bg-clip-text text-transparent bg-gradient-to-r from-amber-600 to-yellow-500 font-semibold text-8xl">Certificate</h3>
          <p className="text-2xl text-black font-mono">My Awards and Achivements</p>
        </div>
      </div>
      <motion.div
