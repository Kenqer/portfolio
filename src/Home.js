                    ...
                    <div className="z-[2]">
                        ...
                        <div className="flex text-2xl md:text-4xl gap-4">
                            <motion.a
                                ...
                                className="hover:scale-110 duration-300 hover:text-purple-800" href="https://www.instagram.com/ken.qer/" target="_blank"><ion-icon name="logo-instagram"></ion-icon></motion.a>
                            <motion.a
                                variants={iconList}
                                initial="hidd"
                                animate="visi"
                            ...
                            <motion.a
                                ...
                                className="hover:scale-110 duration-300 hover:text-red-600" href="https://www.youtube.com/channel/UCXG6GuBh1oHQaYM6TQ7-NRw" target="_blank"><ion-icon name="logo-youtube"></ion-icon></motion.a>
                            <motion.a
                                variants={iconList}
                                initial="hidd"
                                animate="visi"
                                ...
                                className="hover:scale-110 duration-300 hover:text-blue-400" href="https://twitter.com/itisnotken" target="_blank"><ion-icon name="logo-twitter"></ion-icon></motion.a>
                        </div>
                    </div>
                </div>
            </header>
